...
<html lang="fr">
    ...
    <body>
        ...
        <main role="main" class="container">
            ...
            <div class="h1"> 
                Informations du VIP à ajouter
            </div>
            
            <!-- Formulaire d'ajout de VIP -->
            <div class="form-group">
                <form method="POST" action="/PrototypeWeb/vipajoutBD" accept-charset="UTF-8">
                <div class="h2"> 
                    <strong>Nom :</strong> <input type="text" name="surname" class="form-control">
                </div>
                <div class="h2"> 
                    <strong>Prénom : </strong><input type="text" name="name" class="form-control"></h1>
                </div>
                ...
                <img src="${IMAGES}profilPics/profilPic.png" class="profil">
                    ...
                    <!-- Champs coefficient d'importance -->
                    <label><strong>Coefficient d'importance :</strong></label>
                    <input class="form-control" type="number" name="coef"><br>
                    
                    <!-- Champs compagnon VIP -->
                    <label><strong>Compagnon :</strong></label>  
                    <select class="form-control" name="compid">
                        
                                    <!-- Attribution du compagnon du VIP -->
                                    <% 
